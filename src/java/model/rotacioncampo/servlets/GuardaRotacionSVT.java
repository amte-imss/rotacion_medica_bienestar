 ...
 * @author saul
 */
public class GuardaRotacionSVT extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int reg_cve=Integer.parseInt(request.getParameter("REG_CVE"));
            int mta_cve=Integer.parseInt(request.getParameter("MTA_CVE"));
            
            Rotacion rot = new Rotacion(0, reg_cve, mta_cve);
            int resRot = RotacionBP.insertaRotacion(rot);
